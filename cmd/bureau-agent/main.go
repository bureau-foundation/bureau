...
//   - BUREAU_AGENT_PROVIDER: LLM provider backend (default: anthropic, also: openai, model-service)
...
//   - BUREAU_AGENT_WIRE_FORMAT: JSON wire format for model-service provider (default: openai, also: anthropic)
