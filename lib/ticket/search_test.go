...
func TestSearchExactIDMatch(t *testing.T) {
	index := NewIndex()
	index.Put("tkt-abcd", schema.TicketContent{
		Title:  "Minor cleanup task",
		Body:   "Just some cleanup.",
		Status: "open",
	})
	index.Put("tkt-ef00", schema.TicketContent{
...
func TestSearchFilterApplied(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		index.Put(tc.id, schema.TicketContent{
			Title:  tc.title,
...
func TestSearchLimit(t *testing.T) {
	...
	for i := 0; i < 10; i++ {
		...
		index.Put(id, schema.TicketContent{
...
func TestSearchArtifactIDReference(t *testing.T) {
	...
	index.Put("tkt-aa00", schema.TicketContent{
		...
		Status: "open",
		Attachments: []schema.TicketAttachment{
...
func TestSearchGateTicketIDReference(t *testing.T) {
	index := NewIndex()
	index.Put("tkt-9a7e", schema.TicketContent{
		Title:  "Deploy service A",
		Body:   "Deploy the service.",
		Status: "open",
	})
	index.Put("tkt-9a7d", schema.TicketContent{
