...
// service. It maintains secondary indexes over [ticket.TicketContent]
...
// # Dependencies
//
// This package depends on [schema/ticket] for the TicketContent type
// and [schema] for event type constants used in gate watches.
