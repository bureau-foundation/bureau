...
// content pane. Follows the same input-handling pattern as
// FilterModel: the caller routes keystrokes to HandleRune/
// HandleBackspace and reads the results via accessor methods.
...
// foreground to a 256-color palette index. The lipgloss.Color is
// expected to be a numeric string (e.g., "75") — this function
// produces the raw "\x1b[38;5;Nm" escape.
